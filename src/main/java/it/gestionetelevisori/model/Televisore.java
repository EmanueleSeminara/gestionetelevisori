...
public class Televisore {
	...
	@Override
	public int hashCode() {
		return Objects.hash(codice, id, marca, modello, numeroPollici, prezzo);
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Televisore other = (Televisore) obj;
		return Objects.equals(codice, other.codice) && Objects.equals(id, other.id)
				&& Objects.equals(marca, other.marca) && Objects.equals(modello, other.modello)
				&& numeroPollici == other.numeroPollici && prezzo == other.prezzo;
	}

	@Override
	public String toString() {
		return "Televisore [id=" + id + ", marca=" + marca + ", modello=" + modello + ", prezzo=" + prezzo
				+ ", numeroPollici=" + numeroPollici + ", codice=" + codice + "]";
	}
